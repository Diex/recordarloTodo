...
public class Control extends JFrame {
  ...
  ArrayList<VideoFolder> keywords;
  ArrayList<String> videos;
  ArrayList<VideoFolder> keys_list;
  int current_video;
  String state;
  JTextField it;
  JTextArea log;
  ...
  public Control() {
    ...
    this.setSize(ctrl_screen_x, ctrl_screen_y);
  ...
  public void elapsed_time(float t, float lt) {
    ...
    if (state.equals("recording")) {
      ...
      if (!text.equals("")) {
        //println("GUI text = " + text);
        //println("elapsed_time :: Recording");
        //println("elapsed_time :: Current Video = " + current_video);

        t -= lt;

        //println("GUI text = " + text + " | last_text = " + last_text);

        if (text.equals(last_text)) {
          time += t;

          //println("time = " + time + " | stop_talking = " + stop_talking);
